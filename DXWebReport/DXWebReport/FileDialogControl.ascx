<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FileDialogControl.ascx.cs" Inherits="DXWebReport.FileDialogControl" %>
...
<dx:ASPxPopupControl ID="popup" runat="server" EnableClientSideAPI="true" Width="0px"
    ...
    <ContentCollection>
        <dx:PopupControlContentControl runat="server">
            <dx:ASPxFormLayout ID="flDialog" runat="server" ColCount="3" Width="100%">
                <Items>
                    <dx:LayoutItem ColSpan="3" ShowCaption="False">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxFileManager ID="fileManager" runat="server" Width="100%" Height="500px">
                                    <Settings RootFolder="~\App_Data\Reports\" ThumbnailFolder="~\Thumb\" />
                    ...
                    <dx:LayoutItem ShowCaption="False" HorizontalAlign="Right" Width="100px">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
